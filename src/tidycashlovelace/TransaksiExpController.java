 ...
 * @author Amal
 */
public class TransaksiExpController implements Initializable {
    ...
    @FXML
    private TextField tfNamaTransaksi;
    @FXML
    private TextField tfJumlah;
    @FXML
    private TextField tfHarga;
    @FXML
    private TextField tfUbah;
    @FXML
    ...
    @FXML
    private void handleBtnIncomes(ActionEvent event) throws IOException {
...
//              setData
                transaksiArray.add(new Transaksi(nama, tanggal, harga, jumlah, total2));
...
//        Menyembunyikan pane Tambah, Ubah, dan Hapus pada tampilan awal
        ...
        dataXml = new xstream("data_expense", transaksiArray);

        cbUbah.getItems().addAll("Nama", "Tanggal", "Jumlah", "Harga");
